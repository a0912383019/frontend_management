...
import { apiQueryGrowthRateActiveCommissionable } from '@/api'
...
// 取得資料
const growthRateActiveCommissionable = async () => {
  messageKey.value = 'loading'
  apiSuccess.value = false

  try {
    const result = await apiQueryGrowthRateActiveCommissionable({
      hall_name: 'esx',
...
//轉換資料
const transformActivityMemberPeriodBetAmount = (data) => {
  clearChart()

  let valueKey = 'commissionable_growth_rate'
...
onMounted(() => {
  growthRateActiveCommissionable()
})
</script>
<template>
