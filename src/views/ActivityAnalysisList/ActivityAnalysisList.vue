...
import GrowthRate from '@/views/ActivityAnalysisList/GrowthRate.vue'
import GrowthGap from '@/views/ActivityAnalysisList/GrowthGap.vue'
import TotalSum from '@/views/ActivityAnalysisList/TotalSum.vue'
