  ...
  it('api correctly', async () => {
    ...
    const performanceTableData = [
      ...
      },
      {
        ...
        bonus_day_avg: '0',
        bonus_day_avg_rate: '-100',
        commissionable_day_avg: '0',
        commissionable_day_avg_rate: '-100',
        data_duration: '⎻⎻⎻⎻/⎻⎻/⎻⎻ ~ ⎻⎻⎻⎻/⎻⎻/⎻⎻',
        deposit_day_avg: '0',
        deposit_day_avg_rate: '-100',
        payoff_day_avg: '0',
        payoff_day_avg_rate: '100',
        profit_day_avg: '0',
        profit_day_avg_rate: '100'
      }
    ]
    ...
    const proportionTableData = [
      ...
      {
        active_member: 0,
        active_member_rate: '-100',
        activity_duration: '活動後',
        commissionable_people_proportion: '0',
        commissionable_people_proportion_rate: '-100',
        commissionable_proportion: '0',
        commissionable_proportion_rate: '-100',
        data_duration: '⎻⎻⎻⎻/⎻⎻/⎻⎻ ~ ⎻⎻⎻⎻/⎻⎻/⎻⎻',
        deposit_count: 0,
        deposit_count_rate: '0',
        deposit_proportion: '0',
        deposit_proportion_rate: '-100',
        people_tags_count: 0,
        people_tags_count_rate: '0',
        register_in_30_days: 0,
        register_in_30_days_rate: '0'
