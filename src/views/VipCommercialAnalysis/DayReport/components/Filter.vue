...
const { defaultVipTag, dayReportFilter } = vipStore
...
const handleClick = () => {
  ...
  dayReportFilter.searchDate = dayjs(filterData.searchDate).format('YYYY-MM-DD')
  dayReportFilter.vipTag = filterData.vipTag
  emit('update:filter')
  closePopover()
}
